...
build: $(BUILD_DIR)/main.o $(BUILD_DIR)/fetcher.o $(BUILD_DIR)/hn.o $(BUILD_DIR)/client.o
	$(CC) $(BUILD_DIR)/main.o $(BUILD_DIR)/fetcher.o $(BUILD_DIR)/hn.o $(BUILD_DIR)/client.o -o $(BUILD_DIR)/$(TARGET) -ljson-c -lcurl -lpthread
